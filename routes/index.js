...
// * perform different operations in mongodb *
...
router.get("/find", async function (req, res) {
  ...
  // * filter doc data based on sepecific field length *

  //here we use $expr for expression ,  $and and inside this and we use $gte and $late operator inside this we use $strLenCP
